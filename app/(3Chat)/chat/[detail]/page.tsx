...
import MessageSeparator from "./components/messageDateSeparator";
import MessageNotification from "./components/MessageNotification";
// import CustomModal from "@/components/modals/Modal";
// import CustomModalContent from "@/components/modals/CustomModal";
// import Signature from "./components/Signature";
// import CallBubble from "./components/Call";
import { ChatBottom } from "./components/ChatBottom";
// import MessageShare from "./components/Share";
import { ChatDetailPopover } from "./components/ChatDetailPopover";
...
import { ChatExtensions } from "./components/Extensions";
    ...
    <DisplaySpace
      content={
        <div className="h-screen w-full scrollbar-hide relative">
          ...
          <div
            ref={scrollableRef}
            className="overflow-y-scroll overflow-x-hidden scrollbar-hide z-40 h-full bg-grey-light"
          >
            ...
            <MessageBubble
              items={[
                { message: "안녕하세요", timestamp: "오후 1:31", read: true },
                {
                ...
                {
                  message:
                    "max-width 여기까지 늘어납니다. 여기까지 늘어납니다.",
                  timestamp: "오후 1:32",
                  read: true,
                },
              ]}
