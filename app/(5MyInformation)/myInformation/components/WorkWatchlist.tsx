...
import OrderItem from "@/app/(2Ordering)/ordering/components/OrderItem";
...
const AllItems: OrderItemType[] = [
  {
    ...
    isFavorite: true, // Favorite state for each item
  },
  {
    id: 2,
    name: "굴착기 02LC",
...
interface WorkWatchlistProps {
  isAll: boolean;
}
const WorkWatchlist: React.FC<WorkWatchlistProps> = ({ isAll }) => {
